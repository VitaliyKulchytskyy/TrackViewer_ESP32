...
class TFT_eSPI : public Print { friend class TFT_eSprite; // Sprite class has access to protected members
 ...
 public:
  ...
  // Label rendering - value returned is the pixel width of the rendered text
  ...
  // Label rendering and font handling support funtions
...
#endif
  uint32_t textcolor, textbgcolor;         // Label foreground and background colours

  uint32_t bitmap_fg, bitmap_bg;           // Bitmap foreground (bit=1) and background (bit=0) colours

  uint8_t  textfont,  // Current selected font number
           textsize,  // Current font size multiplier
           textdatum, // Label reference datum
 ...
 protected:
  ...
  int32_t  cursor_x, cursor_y, padX;       // Label cursor x,y and padding setting
